...
import nz.ac.massey.cs.care.io.JarReader;
...
public class Utils {
	...
	/**
	 * Returns all resolved types in bottom up order. Excludes Object class. 
	 * @param targetClass
	 * @return
	 */
	public static IType[] getSupertypes(ClassObject targetClass){
...
//			outfolder = outfolder + motif.getName() + "_";
	...
	public static void removeFactoryEdges(DirectedGraph<Vertex, Edge> g) {
		Vertex factory = null;
		for(Vertex v: g.getVertices()) {
