 ...
 * Type Generalization and Service Locator
 * @author Ali
 *
 */
public class TGPlusSLRefactoring extends Refactoring {
	...
	public TGPlusSLRefactoring(Edge winner) {
		this.winner = winner;
	...
	public Change createChange(IProgressMonitor pm) throws CoreException,
		...
		change.add(refactoring2.createChange(pm));//we do this because we are not calling create change on other refactorings
		return change;
	}
