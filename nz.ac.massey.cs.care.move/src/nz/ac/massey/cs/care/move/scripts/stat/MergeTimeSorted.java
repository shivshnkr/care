 ...
 */
public class MergeTimeSorted {
	
	public final static String FOLDER = "output/cd-all/";
	public final static int MAX_ROWS = 2;
	public final static int COLUMN2MERGE = 14; // relative percentage
	public final static String OUTPUT_FILE = "output/stats/"+"merged_time.csv";
	...
	public static void main(String[] args) throws Exception {
		Map<String,List<List<String>>> data = MergeSCCMetrics.parseData(INPUT_FOLDER, POSTFIX2REMOVE);
		...
		Map<String, Integer> sortedDataMap = sortByValue(dataMap);//use dataMap if no sorting required
