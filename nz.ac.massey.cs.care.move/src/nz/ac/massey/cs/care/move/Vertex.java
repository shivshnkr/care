...
public class Vertex extends nz.ac.massey.cs.guery.adapters.jungalt.Vertex<Edge> {
	...
	public void addMethods(Collection<? extends Method_info> collection) {
//		this.methods = (List<Method_info>) collection;
	}
	public void addFields(
			Collection<? extends com.jeantessier.classreader.Field_info> allFields) {
//		this.fields = (List<Field_info>) allFields;
	}
